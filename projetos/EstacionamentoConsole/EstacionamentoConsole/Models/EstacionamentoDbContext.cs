...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Clientes__3213E83F9431D069");

            entity.HasIndex(e => e.Cpf, "UQ__Clientes__D836E71F401E7D3C").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Registro__3213E83F3F9B3BD0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Vagas__3213E83FF13FB324");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Veiculos__3213E83F0DE8A683");

            entity.HasIndex(e => e.Placa, "UQ__Veiculos__0C0574251D966611").IsUnique();
